...
const zh: Record<TranslationKey, string> = {
  ...
  'settings.apiTestTitle': '接口测试',
  'settings.apiTestDesc': '启用接口流量录制面板，用于记录和测试 HTTP 请求。',
  'trafficCapture.title': '流量录制',
  'trafficCapture.start': '开始',
  'trafficCapture.stop': '停止',
  'trafficCapture.urlPlaceholder': '目标 URL（如 https://example.com）',
  'trafficCapture.componentTagPlaceholder': '组件标识过滤',
  'trafficCapture.empty': '暂无捕获的请求',
  'trafficCapture.waiting': '等待请求中...',
  'trafficCapture.deleteSelected': '删除 ({count})',
