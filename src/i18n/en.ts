...
const en = {
  ...
  'settings.apiTestTitle': 'API Test',
  'settings.apiTestDesc': 'Enable API traffic capture panel for recording and testing HTTP requests.',
  'trafficCapture.title': 'Traffic Capture',
  'trafficCapture.start': 'Start',
  'trafficCapture.stop': 'Stop',
  'trafficCapture.urlPlaceholder': 'Target URL (e.g., https://example.com)',
  'trafficCapture.componentTagPlaceholder': 'Component tag filter',
  'trafficCapture.empty': 'No requests captured yet',
  'trafficCapture.waiting': 'Waiting for requests...',
  'trafficCapture.deleteSelected': 'Delete ({count})',
